    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex justify-between items-center">
        ...
        <>
          ...
          <Button onClick={handleUploadClick} leftIcon={<Upload size={18} />}>
            Upload Document
          </Button>
        </>
      </div>
        ...
        <div className="lg:col-span-3">
          <Card>
            ...
            <CardBody>
              <div className="space-y-2">
                {documents.map(doc => (
                  <div key={doc.id} className="flex items-center p-4 hover:bg-gray-50 rounded-lg">
      ...
      <Card>
        ...
        <CardBody>
          {/* ✅ FILE PASSING */}
          <DocumentChamber externalFile={uploadedFile} />
        </CardBody>
      </Card>
